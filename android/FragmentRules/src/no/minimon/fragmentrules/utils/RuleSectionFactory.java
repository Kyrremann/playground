...
import static no.minimon.fragmentrules.RulesApplication.ENGLISH;
import static no.minimon.fragmentrules.RulesApplication.JSON_COST;
import static no.minimon.fragmentrules.RulesApplication.JSON_ID;
import static no.minimon.fragmentrules.RulesApplication.JSON_KEYWORDS;
import static no.minimon.fragmentrules.RulesApplication.JSON_MODIFIER;
import static no.minimon.fragmentrules.RulesApplication.JSON_OWNER;
import static no.minimon.fragmentrules.RulesApplication.JSON_PREREQUISITE;
import static no.minimon.fragmentrules.RulesApplication.JSON_RELIC;
import static no.minimon.fragmentrules.RulesApplication.JSON_SET;
import static no.minimon.fragmentrules.RulesApplication.JSON_TEXT;
import static no.minimon.fragmentrules.RulesApplication.JSON_TYPE;
import static no.minimon.fragmentrules.utils.ImagesInTextFactory.parseText;
